...
describe("Robots.txt FFI Integration tests", () => {
  it.concurrent(
    "handles normal robots.txt parsing via FFI",
    async () => {
  ...
  it.concurrent(
    "handles malformed robots.txt without crashing via FFI",
    async () => {
      const result = await filterLinks({
  ...
  it.concurrent(
    "handles non-UTF8 robots.txt content without crashing via FFI",
    async () => {
  ...
  it.concurrent(
    "handles char boundary issues without crashing via FFI",
    async () => {
