 ...
 * @method static array cancelCrawl(string $jobId)
 * @method static BatchScrapeJob batchScrape(array $urls, ?BatchScrapeOptions $options = null, int $pollIntervalSec = 2, int $timeoutSec = 300)
 * @method static array cancelBatchScrape(string $jobId)
 ...
 * @method static array cancelAgent(string $jobId)
